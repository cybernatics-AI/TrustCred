            ...
            >
              <div className="bg-card rounded-2xl p-8 border border-border shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                ...
                <div className="flex justify-between items-start mb-6">
                  <Quote className="w-8 h-8 text-lemon-lime-500 opacity-60" />
                  <div className="flex space-x-1">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      ...
                      >
                        <Star className="w-4 h-4 fill-lemon-lime-400 text-lemon-lime-400" />
                      </motion.div>
                    ))}
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-lemon-lime-400 to-security-green-500 rounded-full p-0.5">
                ...
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-lemon-lime-500/5 to-security-green-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
              </div>
            </motion.div>
          ))}
        </motion.div>
